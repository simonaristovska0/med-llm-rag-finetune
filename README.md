...
This notebook performs LoRA fine-tuning on a medical instruction dataset. It formats data in ChatML style, trains the model using TRL’s SFTTrainer, and produces LoRA adapters that improve the model’s medical reasoning and communication abilities.
